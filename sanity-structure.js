...
export default () =>
  S.list()
    ...
    .items([
      ...
      S.listItem()
        ...
        .child(
          S.editor()
            .id("whatsOn")
            .schemaType("whatsOn")
            .documentId("singleton-whatsOn")
            .views(getPreview("whatsOn"))
        )
        .icon(FiCalendar),
      S.divider(),
      S.listItem()
            ...
            .items([
              S.listItem()
                ...
                .child(
                  S.editor()
                    .id("newsLanding")
                    .schemaType("newsLanding")
                    .documentId("singleton-newsLanding")
                    .views(getPreview("newsLanding"))
                )
                .icon(FiArchive),
              S.divider(),
              orderableDocumentListDeskItem({
              ...
              S.listItem()
                .title("Categories")
                .child(S.documentTypeList("categories"))
                .icon(FiTag),
            ])
        ),
      S.divider(),
      ...
      S.listItem()
        .title("Policies")
        .child(S.documentTypeList("policies"))
        .icon(FiFileText),
      S.divider(),
      S.listItem()
